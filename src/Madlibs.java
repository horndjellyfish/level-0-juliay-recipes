...
String sentence = ("Piranhas are more "+adj) + (" during the day, so cross the river at night. Piranhas are attracted to fresh\n "+liq) + 
(" and will most likely take a bite out of your "+bod) + (" if you\n "+ver) + 
(". Whatever you do, if you have an open wound, try to find another way to get to "+pla) + 
(". Good luck!");
